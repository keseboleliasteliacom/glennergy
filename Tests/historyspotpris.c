...
//gcc -Wall -Wextra -std=c11 -D_POSIX_C_SOURCE=200112L -D_GNU_SOURCE -ILibs -ILibs/API -ILibs/Cache -ILibs/Utils Tests/historyspotpris.c Libs/Fetcher.c Libs/API/Spotpris.c Libs/Cache/Cache.c -lcurl -ljansson -o Tests/historyspotpris
...
int Spotpris_HistoryFetchArea(AllaSpotpriser *spotpris, time_t start_time, int num_days, SpotprisArea area)
{
    ...
    time_t end_time = start_time + ((num_days - 1) * 86400);
    struct tm *end_tm = localtime(&end_time);
    
    char output_filename[128];
    snprintf(output_filename, sizeof(output_filename), 
             "spotpris_history_%04d%02d%02d_%04d%02d%02d_%s.json",
