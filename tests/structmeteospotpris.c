...
//gcc -Wall -Wextra -std=c11 -D_POSIX_C_SOURCE=200112L -D_GNU_SOURCE -ILibs -ILibs/API -ILibs/cache -ILibs/utils Tests/structmeteospotpris.c Libs/utils/Fetcher.c Libs/API/meteo.c Libs/API/spotpris.c Libs/cache/cache.c -lcurl -ljansson -o Tests/structmeteospotpris
